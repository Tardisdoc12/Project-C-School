...
namespace Collision
{
	...
	public:
		...
		OrientedBoundingBox(const sf::VertexArray& Object){
			Points[0] = Object[0].position;
			float width=Object[1].position.x-Object[0].position.x;
			float height=-(Object[3].position.y-Object[0].position.y);
			Points[1] = sf::Vector2f(width,Object[0].position.y);
			Points[2] = sf::Vector2f(width,height);
			Points[3] = sf::Vector2f(Object[0].position.x,height);
		}
	...
	bool BoundingBoxTest(const sf::Sprite& Object1, const sf::VertexArray& Object2) {
		OrientedBoundingBox OBB1 (Object1);
		OrientedBoundingBox OBB2 (Object2);
